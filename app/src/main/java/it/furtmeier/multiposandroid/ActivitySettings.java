...
public class ActivitySettings extends AppCompatPreferenceActivity {
    ...
    public static class MiscPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference button = findPreference("misc_reload");
            button.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    //code for what you want it to do
                    ActivityMain.webView.reload();
                    getActivity().finish();
                    getActivity().finish();
                    return true;
                }
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("server_cloud"));
            bindPreferenceSummaryToValue(findPreference("server_kasse"));
        }
